      ...
      <div className="relative min-h-screen">
        ...
        <div className="container mx-auto pt-5 px-5">
          ...
          <div className="flex justify-between pb-10">
            ...
            <button className="bg-white text-black py-1 px-2 rounded-xl cursor-pointer text-nowrap">
              Learn more
            </button>
          </div>
          <div className="relative mb-10">
            ...
            <div className="absolute flex bottom-10  w-full  items-center flex-col">
              <h1 className="text-white text-2xl lg:text-4xl text-center font-bold py-2">
          ...
          <div className="relative mb-10" id="joinCC">
            ...
            <div className="absolute bottom-0 w-full h-full flex">
              <div className="w-full lg:w-1/2 flex flex-col justify-center text-center">
                <h1 className="text-white text-xl lg:text-2xl font-medium lg:my-2">
                  Introduce
                </h1>
                <h1 className="text-4xl lg:text-6xl text-white font-bold lg:my-2">Camp Card</h1>
          ...
          <div className="mb-10 relative">
            ...
            <div className="absolute top-0 w-full h-full flex">
              <div className="w-1/2 flex flex-col justify-around m-2 lg:m-10">
                <h1 className="text-white text-2xl lg:text-4xl font-medium">Question About Your Camp?</h1>
                <div className="my-2">
                  <button
                    type="button"
